...
class ShimPool {
  ...
  private:
    // NOT IMPLEMENTED
    ShimPool(const ShimPool&);
    ShimPool& operator=(const ShimPool&);

  public:
    // CREATORS
    explicit
    ShimPool(bsls::Types::size_type  blockSize,
...
//..
//  void *operator new[](bsl::size_t size, BloombergLP::bdlma::ShimPool& pool);
//..
// A user of 'bdlma::ShimPool' may expect to be able to use array 'operator new' as
// follows:
//..
//   new (*pool) my_Type[...];
//..
...
void *operator new(bsl::size_t size, BloombergLP::bdlma::ShimPool& pool);
    ...
    // argument:
    //..
    //  my_Type *newMyType(bdlma::ShimPool *pool, bslma::Allocator *basicAllocator)
    //  {
    ...
    //..
    //  void deleteMyType(my_Type *t, bdlma::ShimPool *pool)
    //  {
    //      pool->deleteObject(t);
    //  }
    //..
...
void operator delete(void *address, BloombergLP::bdlma::ShimPool& pool);
...
namespace bdlma {
                                ...
                                // class ShimPool
                                // ----------
inline ShimPool::ShimPool(bsls::Types::size_type blockSize, bslma::Allocator *basicAllocator)
...
inline ShimPool::ShimPool(bsls::Types::size_type       blockSize,
           bsls::BlockGrowth::Strategy  growthStrategy,
...
inline ShimPool::~ShimPool()
{
}

// MANIPULATORS
inline void ShimPool::reserveCapacity(int /*numBlocks*/)
{
...
// MANIPULATORS
inline
void *ShimPool::allocate()
{
    return (char *) _allocVector->malloc(d_blockSize);
}

inline
void ShimPool::deallocate(void *address)
{
...
template <class TYPE>
inline
void ShimPool::deleteObject(const TYPE *object)
{
...
template <class TYPE>
inline
void ShimPool::deleteObjectRaw(const TYPE *object)
{
    bslma::DeleterHelper::deleteObjectRaw(object, this);
}

inline
void ShimPool::release()
{
...
// ACCESSORS
inline
bsls::Types::size_type ShimPool::blockSize() const
{
    return d_blockSize;
}
...
inline
bslma::Allocator *ShimPool::allocator() const
{
