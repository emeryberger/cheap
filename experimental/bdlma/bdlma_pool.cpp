...
// CREATORS
Pool_REAL::Pool_REAL(bsls::Types::size_type blockSize, bslma::Allocator *basicAllocator)
...
Pool_REAL::Pool_REAL(bsls::Types::size_type       blockSize,
...
// MANIPULATORS
void Pool_REAL::reserveCapacity(int numBlocks)
{
