...
void Multipool_REAL::initialize(bsls::BlockGrowth::Strategy growthStrategy,
...
void Multipool_REAL::initialize(
...
// PRIVATE ACCESSORS
int Multipool_REAL::findPool(bsls::Types::size_type size) const
{
...
// CREATORS
Multipool_REAL::Multipool_REAL(bslma::Allocator *basicAllocator)
...
Multipool_REAL::Multipool_REAL(int               numPools,
...
Multipool_REAL::Multipool_REAL(bsls::BlockGrowth::Strategy  growthStrategy,
                     bslma::Allocator            *basicAllocator)
: d_numPools(k_DEFAULT_NUM_POOLS)
, d_blockList(basicAllocator)
, d_allocator_p(bslma::Default::allocator(basicAllocator))
...
// MANIPULATORS
void *Multipool_REAL::allocate(bsls::Types::size_type size)
{
...
void Multipool_REAL::deallocate(void *address)
{
    BSLS_ASSERT(address);
...
void Multipool_REAL::reserveCapacity(bsls::Types::size_type size, int numBlocks)
{
    BSLS_ASSERT(size <= d_maxBlockSize);
