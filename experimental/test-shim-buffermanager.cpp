...
int main(int argc, char* argv[]) {
  ...
  options.add_options()("help",
                        "Print command-line options")("shuffle",
                                                      "Shuffle ('litter') randomly before starting") ("page-litter-v1", "(V1) Adversary case. If set, overrides all other litter options.") ("page-litter-v2",
                                                                                                                                                                                             "(V2) Adversary case. If set, overrides all other litter options.") ("sleep-timer", "Add a sleep timer between littering and benchmark, which could be used with perf.") ("seed", "Use this seed for shuffling", cxxopts::value<size_t>()) ("buffer", "Use the actual buffer implementation") ("shim", "Use a shim buffer implementation") ("object-size", "Size of objects to allocate", cxxopts::value<int>()) ("bytes-to-read",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               "Bytes to read of each object (in locality iterations).",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               cxxopts::
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   value<int>()) ("working-set", "Size of working set (in bytes)", cxxopts::value<int>()) ("loops", "Number of loops", cxxopts::value<int>()) ("litter-objects",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               "Number of objects to litter",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               cxxopts::value<
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   int>()) ("litter-occupancy", "Occupancy after littering (between 0 and 1).", cxxopts::value<float>()) ("locality-iterations",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          "Locality iterations (non-allocating)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          cxxopts::
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              value<
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  int>());
