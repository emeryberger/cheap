...
MACOS_SRC = lib$(LIBNAME).cpp printf.cpp Heap-Layers/wrappers/macwrapper.cpp
...
MACOS_COMPILE = $(CXX) -ftls-model=initial-exec -ftemplate-depth=1024 -arch x86_64  -pipe $(CPPFLAGS) $(INCLUDES) -D_REENTRANT=1 -compatibility_version 1 -current_version 1 -D'CUSTOM_PREFIX(x)=xx\#\#x' $(MACOS_SRC) -dynamiclib -install_name $(DESTDIR)$(PREFIX)/lib$(LIBNAME).dylib -o lib$(LIBNAME).dylib -Lvendor/libbacktrace/.libs -lbacktrace -ldl -lpthread
